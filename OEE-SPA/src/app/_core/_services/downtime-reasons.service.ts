...
export class DowntimeReasonsService {
  ...
  getDowntimeReasonDetail(reason_1: string): Observable<string[]> {
    return this.http.get<string[]>(this.baseUrl + 'DowntimeReason/getDowntimeReasonDetail?reason_1=' + reason_1);
  }
  getDowntimeReasonType(): Observable<string[]> {
    return this.http.get<string[]>(this.baseUrl + 'DowntimeReason/getDowntimeReasonType');
  }
  addDowntimeReason(downtimereason: Downtimereason): Observable<any> {
    return this.http.post<ChartReason>(this.baseUrl + 'DowntimeReason/addDowntimeReason', downtimereason);
  }
  ...
  getReasons(item: number): Observable<Downtimereason> {
    return this.http.get<Downtimereason>(this.baseUrl + 'DowntimeReason/getReasons?item=' + item);
  }
}
